...
You can install the units (and configure them by running `python pi_rec/utils/install_systemd_unit`. Run with the `--help` flag to get information about how to specify the script.)
